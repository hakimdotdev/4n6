...
namespace AutoRecon.Domain.Entities.Fido2;
...
public class FidoStoredCredential
{
    ...
    {
        get => string.IsNullOrWhiteSpace(DescriptorJson)
            ? null
            : JsonSerializer.Deserialize<PublicKeyCredentialDescriptor>(DescriptorJson);
