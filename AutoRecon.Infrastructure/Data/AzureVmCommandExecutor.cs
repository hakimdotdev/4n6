...
namespace AutoRecon.Infrastructure.Data;

public class AzureVmCommandExecutor(
    string clientId,
    string clientSecret,
    string tenantId,
    string subscriptionId,
    string resourceGroupName,
    string vmName) : ICommandExecutor
{
    ...
    public async Task ExecAsync(string command, string[] args, CancellationToken cancellationToken = default)
    {
        ...
        var virtualMachineResourceId =
            VirtualMachineResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, vmName);
        var virtualMachine = armClient.GetVirtualMachineResource(virtualMachineResourceId);
